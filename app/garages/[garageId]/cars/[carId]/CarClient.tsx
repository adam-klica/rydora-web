...
interface CarClientProps {
  ...
  initialRating: GarageRating | null;
}

export default function CarClient({ garageId, carId, initialCar, initialRating }: CarClientProps) {
  const router = useRouter();
  const [car, setCar] = useState<CarData | null>(initialCar);
  const [garageRating, setGarageRating] = useState<GarageRating | null>(initialRating);
